...
void send_SerialCommand(float erro){
	int velocidade = abs(erro*255);

	char vel_char[3];

	vel_char[0] = convetToChar(velocidade/100);
	velocidade = velocidade%100;
	vel_char[1] = convetToChar(velocidade/10);
	velocidade = velocidade%10;
	vel_char[2] = convetToChar(velocidade);
